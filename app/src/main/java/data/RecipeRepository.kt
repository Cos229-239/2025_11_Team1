    ...
    private val recipes = mapOf(
        "Happy" to listOf(
            ...
            Recipe(
                ...
                ingredients = listOf("3 scoops vanilla ice cream", "1/2 cup hot fudge or caramel sauce", "1/4 cup of whipped cream", "2 cherries", "2 tablespoons chopped nuts"),
            ...
            Recipe(
                ...
                ingredients = listOf("1 cup fresh lemon juice", "1/2 cup of sugar", "4 cups sparkling water", "Ice cubes", "Lemon slices for garnish"),
            ...
            Recipe(
                ...
                ingredients = listOf("2 lbs beef tenderloin", "3 tablespoons olive oil", "4 cloves minced garlic", "2 tablespoons fresh thyme", "1 teaspoon salt", "1 teaspoon black pepper"),
            ...
            Recipe(
                ...
                ingredients = listOf("6 fresh or 1 can peaches", "1 cup sugar", "1 cup flour", "1 cup milk", "1 stick melted butter", "2 teaspoons baking powder", "1 teaspoon vanilla extract", "1/2 teaspoon cinnamon"),
        ...
        "Tired" to listOf(
            Recipe(
                ...
                ingredients = listOf("2 slices of bread", "1 ripe avocado", "1 tablespoon lemon juice", "Salt to taste", "Red pepper flakes"),
            ...
            Recipe(
                ...
                ingredients = listOf("2 cups cooked shredded chicken", "8 cups chicken broth", "2 cups egg noodles", "3 carrots sliced", "3 celery stalks chopped", "3 cloves minced garlic", "2 tablespoons olive oil", "1 teaspoon thyme", "Salt and pepper to taste", "Fresh parsley for garnish"),
            ...
            Recipe(
                ...
                ingredients = listOf("4 large russet potatoes peeled and cubed", "1/2 cup butter", "1/2 cup milk", "1/4 cup sour cream", "Salt to taste", "Black pepper to taste"),
            ...
            Recipe(
                ...
                ingredients = listOf("2 slices bread", "2 slices cheddar cheese", "2 tablespoons butter", "Pinch of salt"),
            ...
            Recipe(
                ...
                ingredients = listOf("1 cup rice", "6 cups water or chicken broth", "1 teaspoon salt", "2 tablespoons ginger minced", "1 tablespoon sesame oil", "Soy sauce to taste", "Soft boiled egg for topping"),
        ...
        "Cozy" to listOf(
            Recipe(
                "Tomato Soup",
                "Warm and nostalgic.",
                ingredients = listOf("4 cups tomatoes", "2 cups vegetable broth", "1 onion diced", "2 cloves garlic", "Salt and pepper"),
            ...
            Recipe(
                ...
                ingredients = listOf("2 cups elbow macaroni", "2 cups cheddar cheese", "2 cups milk", "3 tablespoons butter", "3 tablespoons flour", "Salt and Pepper to taste"),
            ...
            Recipe(
                "Caprese Salad",
                "Pure and light.",
                ingredients = listOf("2 large tomatoes sliced", "8 oz fresh mozzarella sliced", "Fresh basil leaves", "3 tablespoons olive oil", "2 tablespoons balsamic vinegar", "Salt and pepper to taste"),
            ...
            Recipe(
                "Banana Pudding",
                "Mellow and gentle.",
                ingredients = listOf("4 ripe bananas sliced", "2 cups vanilla pudding", "1 box vanilla wafers", "2 cups whipped cream", "1 teaspoon vanilla extract"),
            ...
            Recipe(
                "Pancakes",
                "Fluffy and tender.",
                ingredients = listOf("2 cups flour", "2 tablespoons sugar", "2 teaspoons baking powder", "1/2 teaspoon salt", "2 eggs", "1 3/4 cup milk", "1/4 cup melted butter", "Maple syrup for serving"),
            ...
            Recipe(
                ...
                ingredients = listOf("2 cans navy beans drained", "1/2 cup ketchup", "1/4 cup brown sugar", "2 tablespoons molasses", "1 teaspoon mustard", "4 slices bacon chopped"),
        ...
        "Stressed" to listOf(
            Recipe(
                "Green Tea",
                "Relax and breathe.",
                ingredients = listOf("1 green tea bag", "1 cup hot water", "1 teaspoon honey", "Lemon slice optional"),
            ...
            Recipe(
                ...
                ingredients = listOf("1 1/2 cups flour", "1/2 cup cocoa powder", "1 cup sugar", "1 teaspoon baking soda", "1/2 teaspoon salt", "1 cup milk", "1/3 cup vegetable oil", "1 egg", "1 teaspoon vanilla", "1/2 cup dark chocolate chips"),
            ...
            Recipe(
                ...
                ingredients = listOf("2 cups of milk", "2 tablespoons cocoa powder", "2 tablespoons sugar", "1/4 teaspoons vanilla extract", "Marshmallows for topping", "Whipped cream optional"),
            ...
            Recipe(
                ...
                ingredients = listOf("1 cup rolled oats", "2 cups water or milk", "2 tablespoons honey", "1/4 teaspoon cinnamon", "Pinch of salt", "Fresh berries for topping", "Sliced almonds optional"),
            ...
            Recipe(
                ...
                ingredients = listOf("2 salmon fillets", "1/4 cup teriyaki sauce", "1 tablespoon honey", "1 teaspoon sesame oil", "2 cloves minced garlic", "Sesame seeds for garnish", "Green onions sliced"),
            ...
            Recipe(
                ...
                ingredients = listOf("4 eggs", "2 tablespoons milk", "2 tablespoons butter", "Salt and pepper to taste"),
